                        ...
                        <div class="col-lg">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong>สร้างบทความของคุณ</strong> &nbsp;เพื่อดูงดูดความสนใจของลูกค้า                                            
                                        </div>
                                        <div class="card-body card-block">
                                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label for="text-input" class=" form-control-label">ชื่อบทความ : </label>
                                                    </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label for="file-input" class=" form-control-label">เพิ่มรูปบทความ : </label>
                                                    </div>
                                                    <div class="col-12 col-md-9">
