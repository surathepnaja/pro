                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                            <strong class="card-title">คอร์ส : InDepth Exercise  
                                                <label class="switch switch-3d switch-success mr-3 float-right mt-1">
                                        ...
                                        <a href="course.php">           
                                                <img class="card-img-top" src="images/coures/1.jpg" alt="Card image cap" >
                                        </a>
                                    
                                    <div class="card-body">
                                        <h4 class="card-title mb-3">หมวดหมู่ : Body Weight</h4>
                                        <h4 class="card-title mb-3">รูปแบบการสอน : เทรนเดียว</h4>
