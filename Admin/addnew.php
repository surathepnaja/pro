                        ...
                        <div class="col-lg">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong>เพิ่มข่าวสาร</strong> &nbsp;ที่ต้องการเเจ้งเทรนเนอร์และลูกค้า
                                        </div>
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label for="text-input" class=" form-control-label">หัวข้อ : </label>
                                                    </div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" id="text-input" name="text-input" placeholder="Headline" class="form-control">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <textarea name="textarea-input" id="textarea-input" rows="9" placeholder="Contents" class="form-control"></textarea>
                                                    </div>
                                                </div>   
                                             
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label for="file-input" class=" form-control-label">เพิ่มรูปปก : </label>
                                                    </div>
                                                    <div class="col-12 col-md-9">
