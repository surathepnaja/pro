                   ...
                   <ul class="navbar-nav ml-auto">                      
                        ...
                        <li class="nav-item active dropdown">
                              ...
                              <div class="dropdown-menu text-center">
                                <a class="dropdown-item active" href="/pro/User/nutrition.php">Nutrition Articles</a>
                        ...
                        <div class="col-xl-3">
                            ...
                            <aside class="menu-sidebar3 js-spe-sidebar">
                                <nav class="navbar-sidebar2 navbar-sidebar3">
                                  <h1 class="my-3"> &nbsp;บทความน่าสนใจ</h1>
                                    <div class="list-group text-center">
                                        <a href="nutrition.php" class="list-group-item active">Nutrition Articles</a>
                                        <a href="#" class="list-group-item">Cardio</a>
                                        <a href="#" class="list-group-item">Weight training</a>
                                        <a href="#" class="list-group-item">News Update</a>
                                        <a href="#" class="list-group-item">Foods</a>
                                        <a href="#" class="list-group-item">Yoga</a>    
                                    </div>
                                </nav>
                            </aside>
                            <!-- END MENU SIDEBAR-->
                        ...
                        <div class="col-xl-9">
                            ...
                            <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"></li>Nutrition Articles</li>
                                    </ol>
                            </nav>
                            ...
                            <div class="page-content">
                                <div class="row">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                    ...
                                                    <strong class="card-title mb-3"> <a href="" class="card-link">Ploys &nbsp; Healthdiary</a>   </strong> 
                                                        ...
                                                        <div class="card-body">
                                                            <h5 class="card-title mb-3">หัวข้อ : กะอาหารให้แม่น แบบไร้ตาชั่ง</h5>
                                                            <p class="card-text">หัวใจหลักของการกะสารอาหารคือ แยกหมวด ข้าวแป้งเส้น / เนื้อสัตว์ / ผัก / ผลไม้ และกะปริมาณให้เข้าตามหน่วยวัดที่เหมาะสม ได้แก่ ข้าว เส้น .... 
                                                            <a href="nutrition1.php" class="card-link">อ่านต่อ</a> 
                                                            </p>
                                                        </div>
                                                        ...
                                                        <div class="card-footer">
                                                              <div class="col-md-12">
                                                                    ...
                                                                    <button type="button" class="btn btn-success"><i class="far fa-share-square"></i>&nbsp; แชร์</button>
                                                                    <button type="button" class="btn btn-danger"><i class="far fa-bell"></i>&nbsp;ติดตาม</button>
                                                              </div>
                                                        </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-header">
                                                    ...
                                                    <strong class="card-title mb-3"> <a href="" class="card-link">Ploys &nbsp; Healthdiary</a>   </strong> 
                                                        ...
                                                        <a href="bodyweight1.php">           
                                                                <img class="card-img-top" src="images/blog/5.png" alt="Card image cap" >
                                                        </a>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            <div class="card-header">
                                                    <img src="img/index/view4.jpg" class="rounded-circle" alt="Cinque Terre" width="50" height="50" href="">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <strong class="card-title mb-3"> <a href="" class="card-link">Ploys &nbsp; Healthdiary</a>   </strong> 
                                            </div>
                                                        <a href="bodyweight1.php">           
