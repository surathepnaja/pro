                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <input class="au-input au-input--xl" type="text" name="search" placeholder="ค้นหาสิ่งที่คุณต้องการ" />
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="profile.php">
                                                        <i class="zmdi zmdi-account"></i>โปรไฟล์</a>
                                                </div>
                                                <div class="account-dropdown__item">
                                                    <a href="#">
                                                        <i class="zmdi zmdi-settings"></i>แก้ไข</a>
                                                </div>
                                                <div class="account-dropdown__item">
                                                    <a href="#">
                                                        <i class="zmdi zmdi-money-box"></i>รายได้</a>
                                                </div>
                                            </div>
                                ...
                                <div class="overview-item overview-item--c1">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span>เทรน์เนอร์ที่คุณติดตาม </span>
                                                    <h2>5 คน</h2>
                                                <span>ลูกค้าที่ เรียนกับคุณ </span>
                                            </div>
                                        </div>
                                ...
                                <div class="overview-item overview-item--c2">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text"> 
                                                <span>ค่าดัชนีมวลกาย (BMI)</span>
                                                <h2>20</h2>
                                                <span>น้ำหนักปกติ เหมาะสม</span>
                                            </div>
                                        </div>
                                        <div class="overview-chart">
                                ...
                                <div class="overview-item overview-item--c3">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                            <span> พลังงานที่จำเป็นพื้นฐานในการมีชีวิต (BMR)</span>
                                                <h2>1655 Kcal</h2>
                                                <span> </span>
                                            </div>
                                        </div>
                                ...
                                <div class="overview-item overview-item--c4">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span>ค่าของพลังงานที่ใช้ทั้งหมดในแต่ละวัน (TDEE) </span>
                                                <h2>2276 Kcal</h2>
                                            </div>
                                        </div>
                                        <div class="overview-chart">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="au-card chart-percent-card">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 tm-b-5">ข้อลูกค้าที่เทรนนิ่งกับคุณ %</h3>
                            ...
                            <div class="col-lg-6">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                        ...
                                        <h3>
                                            <i class="zmdi zmdi-account-calendar"></i>งานนัดหมาย ที่ใกล้จะมาถึง</h3>
                                    ...
                                    <div class="au-task js-list-load">
                                        ...
                                        <div class="au-task__footer">
                                            <button class="au-btn au-btn-load js-load-btn">ดูเพิ่มเติม</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-02.jpg');">
                                        <div class="bg-overlay bg-overlay--blue"></div>
                                        <h3>
                                            <i class="zmdi zmdi-comment-text"></i>ข้อความจากลูกค้า</h3>
                                        <button class="au-btn-plus">
                                            <i class="zmdi zmdi-plus"></i>
                                        </button>
                                    </div>
